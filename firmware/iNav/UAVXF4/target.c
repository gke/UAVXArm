...
BUSDEV_REGISTER_SPI_TAG(busdev_mpu6000, DEVHW_MPU6000, BUS_SPI2, PB12, NONE, 0, DEVFLAGS_NONE);
BUSDEV_REGISTER_SPI(busdev_ms5611, DEVHW_MS5611, BUS_SPI2, PC5, NONE, DEVFLAGS_USE_RAW_REGISTERS);
BUSDEV_REGISTER_SPI(busdev_hmc5883, DEVHW_HMC5883, BUS_SPI2, PC4, NONE, DEVFLAGS_NONE);
