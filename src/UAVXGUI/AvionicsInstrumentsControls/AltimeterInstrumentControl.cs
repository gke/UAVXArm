...
namespace Instruments
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        Bitmap bmpSmallNeedle = new Bitmap(Instruments.AvionicsInstrumentsControls.AvionicsInstrumentsControlsResources.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(Instruments.AvionicsInstrumentsControls.AvionicsInstrumentsControlsResources.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(Instruments.AvionicsInstrumentsControls.AvionicsInstrumentsControlsResources.Bandeau_Derouleur);
