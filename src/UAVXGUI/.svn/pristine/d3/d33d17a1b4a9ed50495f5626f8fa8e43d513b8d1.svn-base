...
namespace Instruments
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        Bitmap bmpBoule = new Bitmap(Instruments.AvionicsInstrumentsControls.AvionicsInstrumentsControlsResources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(Instruments.AvionicsInstrumentsControls.AvionicsInstrumentsControlsResources.Maquette_Avion);
