...
namespace Instruments
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(Instruments.AvionicsInstrumentsControls.AvionicsInstrumentsControlsResources.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(Instruments.AvionicsInstrumentsControls.AvionicsInstrumentsControlsResources.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(Instruments.AvionicsInstrumentsControls.AvionicsInstrumentsControlsResources.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(Instruments.AvionicsInstrumentsControls.AvionicsInstrumentsControlsResources.TurnCoordinatorMarks);
